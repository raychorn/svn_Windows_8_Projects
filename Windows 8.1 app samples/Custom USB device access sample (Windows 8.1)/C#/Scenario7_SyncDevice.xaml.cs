...
namespace CustomUsbDeviceAccess
{
    ...
    public sealed partial class SyncDevice: SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private Task<DeviceTriggerResult> StartSyncBackgroundTaskAsync()
        {
            ...
            return syncBackgroundTaskTrigger.RequestAsync(EventHandlerForDevice.Current.DeviceInformation.Id).AsTask();
        }
            ...
            await rootPage.Dispatcher.RunAsync(CoreDispatcherPriority.Normal,
                new DispatchedHandler(async () =>
                {
                    ...
                    if (!isSyncing && errorMessage != null)
                    {
                        ...
                        await EventHandlerForDevice.Current.OpenDeviceAsync(EventHandlerForDevice.Current.DeviceInformation, EventHandlerForDevice.Current.DeviceSelector);

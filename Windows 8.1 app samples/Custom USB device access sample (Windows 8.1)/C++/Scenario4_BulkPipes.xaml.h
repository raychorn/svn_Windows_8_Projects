...
namespace SDKSample
{
    namespace CustomUsbDeviceAccess
    {
        ...
        private:
            ...
            Concurrency::task<void> BulkWriteAsync(uint32 bulkPipeIndex, uint32 bytesToWrite);
            Concurrency::task<void> BulkReadAsync(uint32 bulkPipeIndex, uint32 bytesToRead);

            Concurrency::task<void> BulkReadWriteAsync(uint32 bulkInPipeIndex, uint32 bulkOutPipeIndex, uint32 bytesToReadWrite);

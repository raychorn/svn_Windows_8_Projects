...
(function () {
    ...
    var ControlTransferClass = WinJS.Class.define(null, {
        ...
        setOsrFx2SevenSegmentAsync: function (numericValue) {
            ...
            var initSetupPacket = new Windows.Devices.Usb.UsbSetupPacket();
            initSetupPacket.requestType.recipient = Windows.Devices.Usb.UsbControlRecipient.device;
            initSetupPacket.requestType.controlTransferType = Windows.Devices.Usb.UsbControlTransferType.vendor;
            initSetupPacket.request = SdkSample.Constants.osrFx2.vendorCommand.setSevenSegment;
            initSetupPacket.value = 0;
            initSetupPacket.length = bufferToSend.length;

            return SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.device.sendControlOutTransferAsync(initSetupPacket, bufferToSend)
        ...
        setSuperMuttLedBlinkPatternAsync: function (pattern) {
            ...
            initSetupPacket.requestType.recipient = Windows.Devices.Usb.UsbControlRecipient.device;
            initSetupPacket.requestType.controlTransferType = Windows.Devices.Usb.UsbControlTransferType.vendor;
            initSetupPacket.request = SdkSample.Constants.superMutt.vendorCommand.setLedBlinkPattern;
            initSetupPacket.value = pattern;
            initSetupPacket.length = 0;

            return SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.device.sendControlOutTransferAsync(initSetupPacket)
                .then(function (bytesTransferred) {
        ...
        sendVendorControlTransferInToDeviceRecipientAsync: function (vendorCommand, dataPacketLength) {
            ...
            initSetupPacket.requestType.recipient = Windows.Devices.Usb.UsbControlRecipient.device;
            initSetupPacket.requestType.controlTransferType = Windows.Devices.Usb.UsbControlTransferType.vendor;
            initSetupPacket.request = vendorCommand;
            initSetupPacket.length = dataPacketLength;
        
            return SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.device.sendControlInTransferAsync(initSetupPacket, buffer);
        }
    }, 
    null);

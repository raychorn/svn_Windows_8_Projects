...
(function () {
    ...
    var SyncDeviceClass = WinJS.Class.define(null, {
        ...
        syncWithDeviceAsync: function () {
            ...
            return this._startSyncBackgroundTaskAsync().then(function (deviceTriggerResult) {
                ...
                if (!syncDevice.isSyncing && errorMessage) {
                    SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.openDeviceAsync(
                        SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.deviceInformation,
                        SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.deviceSelector).then(function (openDeviceSuccess) {
        ...
        _startSyncBackgroundTaskAsync: function () {
            ...
            return this.syncBackgroundTaskTrigger.requestAsync(SdkSample.CustomUsbDeviceAccess.eventHandlerForDevice.current.deviceInformation.id);
        },
        /// <summary>

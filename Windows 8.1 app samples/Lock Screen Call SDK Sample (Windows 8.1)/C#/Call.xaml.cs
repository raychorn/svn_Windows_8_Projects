...
namespace LockScreenCall
{
    ...
    public sealed partial class CallPage : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (callDuration > 0)
            {
                hangUpTimer = ThreadPoolTimer.CreateTimer(OtherPartyHangsUp, System.TimeSpan.FromSeconds(callDuration));
            }
        }
        ...
        private void QueueOnUIThread(Windows.UI.Core.DispatchedHandler e)
        {
            var ignored = this.Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, e);
        }
        ...
        private System.Threading.Tasks.Task FadeToBlackAsync()
        {
            ...
            System.EventHandler<object> completed = null;
            completed = (o, e) =>
            {

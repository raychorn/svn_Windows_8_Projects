    ...
    var FirmwareUpdateClass = WinJS.Class.define(null, {
        ...
        updateFirmwareForFirstEnumeratedDeviceAsync: function () {
            return this.findFirstSuperMuttDeviceAsync().then(function (firstSuperMuttDeviceInformation) {
                firmwareUpdate.deviceToDoFirmwareUpdate = firstSuperMuttDeviceInformation;
            }).then(function () {
                if (firmwareUpdate.deviceToDoFirmwareUpdate) {
                    // Open device here and get permission from the user
                    return Windows.Devices.Usb.UsbDevice.fromIdAsync(firmwareUpdate.deviceToDoFirmwareUpdate.id).then(function (usbDevice) {
                        if (usbDevice) {
                            ...
                            return firmwareUpdate.startFirmwareForDeviceAsync(firmwareUpdate.deviceToDoFirmwareUpdate);
                        } else {
        ...
        onFirmwareUpdateCompleted: function (args) {
            ...
            if (taskCompleteStatus === SdkSample.Constants.firmwareUpdateTaskInformation.taskCompleted) {
                ...
                Windows.Devices.Usb.UsbDevice.fromIdAsync(firmwareUpdate.deviceToDoFirmwareUpdate.id).then(function (usbDevice) {
                    var newFirmwareVersion = "0x" + usbDevice.deviceDescriptor.bcdDeviceRevision.toString(16);
                    ...
                    usbDevice.close();
                    usbDevice = null;
                    firmwareUpdate.deviceToDoFirmwareUpdate = null;
                });

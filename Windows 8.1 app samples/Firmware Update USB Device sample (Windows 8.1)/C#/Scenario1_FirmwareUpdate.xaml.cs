...
namespace FirmwareUpdateUsbDevice
{
    ...
    public sealed partial class FirmwareUpdate : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private DeviceInformation deviceToDoFirmwareUpdate = null;
        ...
        {
            deviceToDoFirmwareUpdate = await FindFirstSuperMuttDeviceAsync();
            ...
            await rootPage.Dispatcher.RunAsync(CoreDispatcherPriority.Normal,
                new DispatchedHandler(async () =>
                {
                    ...
                    if (taskCompleteStatus == FirmwareUpdateTaskInformation.TaskCompleted)
                    {
                        ...
                        var newFirmwareVersion = "0x" + usbDevice.DeviceDescriptor.BcdDeviceRevision.ToString("X4", NumberFormatInfo.InvariantInfo);
                        UpdateNewFirmwareVersionInUI(newFirmwareVersion);

                        // Finished updating firmware, we don't need the device or information associated with it anymore
                        usbDevice.Dispose();
                        usbDevice = null;

...
namespace SDKSample
{
    namespace GeolocationCPP
    {
        ...
        {
        private:
            Platform::Collections::Vector<Object^>^ geofenceBackgroundEvents;
        ...
        private:
            ...
            void UpdateUIAfterPositionFix();
            void UpdateUIWithPosition(Windows::Devices::Geolocation::Geoposition^ pos);
            void DoToast(int numEventsOfInterest, Platform::String^ eventName);
            void DoTile(int numEventsOfInterest, Platform::String^ eventName);
            void DoBadge(int numEventsOfInterest);
        };
    }
}

...
namespace BarcodeScannerCS
{
    ...
    public sealed partial class Scenario2 : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private async void claimedBarcodeScannerInstance1_DataReceived(ClaimedBarcodeScanner sender, BarcodeScannerDataReceivedEventArgs args)
        {
            ...
            {
                var dataReader = DataReader.FromBuffer(args.Report.ScanData);
                scanData = dataReader.ReadString(args.Report.ScanData.Length);
            }


            if (args.Report.ScanDataLabel != null)
            {
                var dataReader = DataReader.FromBuffer(args.Report.ScanDataLabel);
                scanDataLabel = dataReader.ReadString(args.Report.ScanDataLabel.Length);
            }

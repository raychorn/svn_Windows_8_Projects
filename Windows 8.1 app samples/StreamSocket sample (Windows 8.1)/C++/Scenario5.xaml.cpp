...
void Scenario5::ConnectSocketWithRetry(HostName^ hostName, String^ serviceName)
{
    ...
    create_task(socket->ConnectAsync(hostName, serviceName, SocketProtectionLevel::Ssl)).then(
    ...
    String^ serviceName)
{
    ...
    return create_task(socket->ConnectAsync(hostName, serviceName, SocketProtectionLevel::Ssl));
}

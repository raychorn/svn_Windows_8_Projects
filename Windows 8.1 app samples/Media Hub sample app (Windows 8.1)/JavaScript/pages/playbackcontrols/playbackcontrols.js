...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/playbackcontrols/playbackcontrols.html", {
        ...
        ready: function (element, options) {
            ...
            document.addEventListener("MSPointerUp", this.disableSrubbing, false);
            document.addEventListener("MSPointerMove", this.setTimeFromMouseEvent, false);

            element.querySelector(".timeContainer .clickeater").onmspointerdown = Application.navigator.pageControl.enableSrubbing;

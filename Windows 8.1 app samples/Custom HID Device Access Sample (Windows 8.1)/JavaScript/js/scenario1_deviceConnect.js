    ...
    var DeviceConnectClass = WinJS.Class.define(function () {
        ...
        _onDeviceRemoved: function (deviceInformationUpdate) {
            ...
            if (!window.buttonDisconnectFromDevice.disabled
                && (SdkSample.CustomHidDeviceAccess.eventHandlerForDevice.current.deviceInformation.id === deviceInformationUpdate.id)) {
        ...
        _onDeviceAdded: function (deviceInformation, deviceSelector) {
            ...
            if (SdkSample.CustomHidDeviceAccess.eventHandlerForDevice.current.isEnabledAutoReconnect
                && (SdkSample.CustomHidDeviceAccess.eventHandlerForDevice.current.deviceInformation)
                && (SdkSample.CustomHidDeviceAccess.eventHandlerForDevice.current.deviceInformation.id === deviceInformation.id)) {

...
void DirectXPanelBase::CreateSizeDependentResources()
{
    ...
    m_renderTargetWidth = (float)max(this->Width * this->CompositionScaleX, 1);
    m_renderTargetHeight = (float)max(this->Height * this->CompositionScaleY, 1);    
    ...
    D2D1_BITMAP_PROPERTIES1 bitmapProperties =
        ...
        m_dipsPerInch * CompositionScaleX,
        m_dipsPerInch * CompositionScaleY
        );
    ...
    m_d2dContext->SetDpi(m_dipsPerInch * CompositionScaleX, m_dipsPerInch * CompositionScaleY);

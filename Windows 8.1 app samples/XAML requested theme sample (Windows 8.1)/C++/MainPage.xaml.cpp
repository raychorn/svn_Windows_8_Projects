...
String^ MainPage::DetermineVisualState(ApplicationViewState viewState)
{
	switch (viewState)
	{
...
void MainPage::InvalidateViewState()
{
	...
	VisualStateManager::GoToState(InputSection, "Input" + DetermineVisualState(ApplicationView::Value), false);
	VisualStateManager::GoToState(OutputSection, "Output" + DetermineVisualState(ApplicationView::Value), false);
}

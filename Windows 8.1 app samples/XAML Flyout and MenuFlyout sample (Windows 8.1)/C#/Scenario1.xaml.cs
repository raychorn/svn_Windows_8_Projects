...
namespace Flyouts
{
    ...
    public sealed partial class Scenario1 : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private void baz_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (item != null)
            {
                if (item.IsChecked)
                {
                    rootPage.NotifyUser("You enabled baz", NotifyType.StatusMessage);
                }
                else
                {
                    rootPage.NotifyUser("You disabled baz", NotifyType.StatusMessage);
                }
            }
        }
    }

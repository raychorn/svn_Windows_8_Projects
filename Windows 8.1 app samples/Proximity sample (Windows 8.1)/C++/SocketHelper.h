...
namespace ProximityCPP
{
    ...
    public: 
        Peers() :
            m_items(ref new Platform::Collections::Vector<Windows::Networking::Proximity::PeerInformation^>())
        {}

        property Windows::Foundation::Collections::IObservableVector<Windows::Networking::Proximity::PeerInformation^>^ Items 
        { 
            Windows::Foundation::Collections::IObservableVector<Windows::Networking::Proximity::PeerInformation^>^ get() { return m_items; }
        } 
    private:
        Platform::Collections::Vector<Windows::Networking::Proximity::PeerInformation^>^ m_items;
    };

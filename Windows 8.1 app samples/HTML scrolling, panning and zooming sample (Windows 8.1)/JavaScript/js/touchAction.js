(function () {
    ...
    var page = WinJS.UI.Pages.define("/html/touchAction.html", {
        processed: function (element, options) {
            ...
            document.getElementById("scaleElement").addEventListener("MSPointerDown", downHandler);
            ...
            document.getElementById("horizontalElement").addEventListener("MSPointerDown", downHandler);
            ...
            document.getElementById("verticalElement").addEventListener("MSPointerDown", downHandler);

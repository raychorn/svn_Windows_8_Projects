...
void MainPage::LoadPDF(_In_ StorageFile^ pdfFile)
{
	...
	create_task([this, pdfFile, fileLoadedEvent]()
	{
		...
		auto loadFileTaskContinuation = loadFileTask.then([this, fileLoadedEvent](PdfDocument^ pdfDocumentLocal)
		{
			pdfDocument = pdfDocumentLocal;
...
/// </summary>
void MainPage::OnOpenFileClick(_In_ Platform::Object^ /*sender*/, _In_ Windows::UI::Xaml::RoutedEventArgs^ /*e*/)
{
...
void MainPage::EventHandlerViewChanged(_In_ Platform::Object^ sender, _In_ Windows::UI::Xaml::Controls::ScrollViewerViewChangedEventArgs^ e){
	if (!e->IsIntermediate)
	{
...
void MainPage::EventHandlerViewChangeStarted(_In_ Platform::Object^ /*sender*/, _In_ Windows::UI::Xaml::Controls::SemanticZoomViewChangedEventArgs^ e)
{

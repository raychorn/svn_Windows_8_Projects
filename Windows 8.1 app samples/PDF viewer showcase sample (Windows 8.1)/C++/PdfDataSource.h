...
#pragma endregion
	...
	internal:
		...
		virtual Concurrency::task<Windows::UI::Xaml::Data::LoadMoreItemsResult> LoadMoreItemsOverride(_In_ Concurrency::cancellation_token c, _In_ unsigned int count) override;

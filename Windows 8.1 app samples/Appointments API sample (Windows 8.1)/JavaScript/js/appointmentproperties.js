...
(function () {
    ...
    function createAppointment() {
        ...
        startTime.minutes = time.getMinutes();
        startTime.hours = time.getHours();
        ...
        if (document.querySelector('#durationSelect').selectedIndex === 0) {
            ...
            appointment.duration = (30 * 60 * 1000000000) / 100;
        } else {
            // 1 hour duration is selected
            appointment.duration = (60 * 60 * 1000000000) / 100;
        }
        ...
        if (document.querySelector('#reminderCheckBox').checked) {
            switch (document.querySelector('#reminderSelect').selectedIndex) {
                case 0:
                    appointment.reminder = (15 * 60 * 1000000000) / 100;
                    break;
                case 1:
                    appointment.reminder = (60 * 60 * 1000000000) / 100;
                    break;
                case 2:
                    appointment.reminder = (24 * 60 * 60 * 1000000000) / 100;
                    break;
            }
        }

...
(function () {
    ...
    var page = WinJS.UI.Pages.define("/html/S2-SuggestionsEastAsian.html", {
    ...
    function suggestionsRequestedHandler(eventObject) {
        var queryText = eventObject.detail.queryText,
            linguisticDetails = eventObject.detail.linguisticDetails,
            queryAlternatives = linguisticDetails.queryTextAlternatives,
            suggestionCollection = eventObject.detail.searchSuggestionCollection;
        for (var i = 0, len = queryAlternatives.length; i < len; i++) {
            ...
            for (var j = 0, suggestionLength = suggestionList.length; j < suggestionLength; j++) {
                if (suggestionList[j].substr(0, alternative.length).toLowerCase() === alternative) {
                    suggestionCollection.appendQuerySuggestion(suggestionList[j]);
                }
            }
        }
    }

...
namespace Doto
{
    ...
    public class MainViewModel : ViewModel
    {
        ...
        private async void LoadSettingsAsync()
        {
            ...
            try
            {
                // A 'System.Net.Http.HttpRequestException' thrown on this line indicates that
                // an Azure service needs to be configured for this sample. Please see ReadMe.txt for instructions.
            ...
            if (settings.Count == 0)
            {
                // no settings - default 'light blue' color. 
                AccentColor = "#63a9eb";
                return;
            }

...
void Scenario6::OnNavigatedTo(NavigationEventArgs^ e)
{
	...
	rootPage->BottomAppBar->Opened += ref new Windows::Foundation::EventHandler<Object^>(this, &Scenario6::BottomAppBar_Opened);
	rootPage->BottomAppBar->Closed += ref new Windows::Foundation::EventHandler<Object^>(this, &Scenario6::BottomAppBar_Closed);

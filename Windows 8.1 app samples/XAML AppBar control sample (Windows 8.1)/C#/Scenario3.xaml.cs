...
namespace AppBarControl
{
    ...
    public sealed partial class Scenario3 : Windows.UI.Xaml.Controls.Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            AppBarButton yingyang = new AppBarButton();
            ...
            FontIcon yingyangIcon = new FontIcon();
            yingyangIcon.FontFamily = new Windows.UI.Xaml.Media.FontFamily("Wingdings");
            yingyangIcon.FontSize = 30.0;
            yingyangIcon.Glyph = "\u005B";
            yingyang.Icon = yingyangIcon;

            rightPanel.Children.Add(yingyang);

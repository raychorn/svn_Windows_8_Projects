...
bool Others::windowActive = false;

EventRegistrationToken Others::contentChangedToken;
EventRegistrationToken Others::windowActivatedToken;
...
void Others::OnWindowActivated(Object^ sender, WindowActivatedEventArgs^ e)
{
    windowActive = (e->WindowActivationState != CoreWindowActivationState::Deactivated);
    if (windowActive && needToPrintClipboardFormat)
    {
        HandleClipboardChanged();
    }
}
...
void Others::RegisterClipboardContentChanged_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
    if (registerContentChanged != RegisterClipboardContentChanged->IsChecked->Value)
    {
        ...
        if (registerContentChanged)
        {
            ...
            windowActivatedToken = Window::Current->Activated += ref new WindowActivatedEventHandler(this, &Others::OnWindowActivated);

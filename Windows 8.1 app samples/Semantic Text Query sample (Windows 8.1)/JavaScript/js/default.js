...
(function () {
    ...
    var scenarios = [
        { url: "/html/stringMatches.html", title: "Find matches on a string using the SemanticQuery.Find API" },
        { url: "/html/propertyMatches.html", title: "Find matches in different properties using the SemanticQuery.FindInProperty API" },
        { url: "/html/filePropertiesMatches.html", title: "Find all the matches for files using the GetMatchingPropertiesWithRanges API" }
    ];

    ...
    public sealed partial class GetCurrentTextSegmentFromIndex
    {
        ...
        private void WordSegmentButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (b != null)
            {
                ...
                {
                    notifyText.AppendLine("language tag input is empty ... using generic text segmentation rules.");
                ...
                else
                {
                    ...
                    {
                        notifyText = new StringBuilder("Error: FormatException caught trying to get the input index:\n" + exception.StackTrace + "\n\nPlease check that this value is valid.");
                        rootPage.NotifyUser(notifyText.ToString(), NotifyType.ErrorMessage);
                        return;
                    }
                    catch (OverflowException exception)
                    {
                        notifyText = new StringBuilder("Error: OverflowException caught trying to get the input index:\n" + exception.StackTrace + "\n\nPlease check that this value is valid, and non-negative.");
                        rootPage.NotifyUser(notifyText.ToString(), NotifyType.ErrorMessage);
                        return;
                    }
                ...
                notifyText.AppendLine("Finding word segment for the given index ...\n");
        ...
        private void SelectionSegmentButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (b != null)
            {
                ...
                notifyText.AppendLine("Finding selection segment for the given index ...\n");
                notifyText.AppendLine("Input: \"" + inputStringText + "\"");
                notifyText.AppendLine("Language Tag: \"" + languageTagText + "\"");
                notifyText.AppendLine("Index: " + inputIndex);

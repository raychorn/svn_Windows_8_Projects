...
void TextSegmentation::GetCurrentTextSegmentFromIndex::WordSegmentButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    if (b != nullptr)
    {
        ...
        else
        {
            ...
            {
                notifyText = "Language tag not well formed: \"" + languageTagText + "\"";
                MainPage::Current->NotifyUser(notifyText, NotifyType::ErrorMessage);
                return;
            }
        }
        ...
        else
        {
            ...
            {
                notifyText = "\nError: FormatException caught trying to get the input index:\n" + e->Message + "\n\nPlease check that this value is valid, and non-negative.";
                MainPage::Current->NotifyUser(notifyText, NotifyType::ErrorMessage);
                return;
            }
        ...
        notifyText += "\nFinding word segment for the given index ...\n";

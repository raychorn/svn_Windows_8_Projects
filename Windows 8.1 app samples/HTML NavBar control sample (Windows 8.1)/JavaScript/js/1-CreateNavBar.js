...
(function () {
    ...
    function switchStyle() {
        ...
        if (linkEl.getAttribute('href') === "//Microsoft.WinJS.2.0.Preview/css/ui-light.css") {
            linkEl.setAttribute('href', "//Microsoft.WinJS.2.0.Preview/css/ui-dark.css");
            document.getElementById("switchStyle").innerText = "Switch to light stylesheet";
            document.body.style.backgroundColor = "rgb(20,20,20)";
        } else {
            linkEl.setAttribute('href', "//Microsoft.WinJS.2.0.Preview/css/ui-light.css");

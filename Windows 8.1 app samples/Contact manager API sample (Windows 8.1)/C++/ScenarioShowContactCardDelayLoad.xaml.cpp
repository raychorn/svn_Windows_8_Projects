...
void SDKSample::ContactManager::ScenarioShowContactCardDelayLoad::ShowContactCardDelayLoadButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    ContactCardDelayedDataLoader^ dataLoader = Windows::ApplicationModel::Contacts::ContactManager::ShowDelayLoadedContactCard(contact, rect, Windows::UI::Popups::Placement::Default);

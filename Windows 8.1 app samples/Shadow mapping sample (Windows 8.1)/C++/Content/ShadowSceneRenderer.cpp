...
ShadowSceneRenderer::ShadowSceneRenderer(const std::shared_ptr<DeviceResources>& deviceResources) :
...
void ShadowSceneRenderer::CreateDeviceDependentResources()
{
    ...
    auto createShadowBuffersTask = (createShadowPSPointTask && createShadowPSLinearTask).then([this]()
    {
        ...
        // <SnippetFeatureLevel9ShadowBuffer>
...
{
    Rect windowBounds = m_deviceResources->GetWindowBounds();

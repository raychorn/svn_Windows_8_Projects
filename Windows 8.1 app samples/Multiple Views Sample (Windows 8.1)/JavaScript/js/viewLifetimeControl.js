    ...
    WinJS.Namespace.define("MultipleViews", {
        ...
        ViewManager: WinJS.Class.define(function () {
            ...
            window.addEventListener("message", function (e) {
                if (e.origin === MultipleViews.thisDomain && e.data.type) {
        ...
        },
        {
            ...
            createNewView: function (page, initData) {
                if (!page) {
                    throw "Must specify a page in your app";
                }
                ...
                var newProxy = new MultipleViews.ViewLifetimeControlProxy(newView);
        ...
        },
        {
            _alertView: function (type, data) {
                ...
                this.appView.postMessage(data, MultipleViews.thisDomain);
            },
            _refCount: 0,
            appView: null,
            _handleMessage: function (e) {
                ...
                switch (data.type) {
                    ...
                    case messageTypes.titleUpdated:
                        ...
                        break;
                    default:
                        throw "Invalid message type, or a message type not meant for proxies was provided";                        
                }
            },
        ...
        // ViewLifetimeControl is a mix class for tracking secondary views
        ...
        }, 
        {
            ...
            _alertProxy: function (type, data) {
                ...
                this.opener.postMessage(data, MultipleViews.thisDomain);
            },
            _handleMessage: function (e) {
                var data = e.data;
                switch (data.type) {
                    ...
                    case messageTypes.initialize:
                        ...
                        break;
                    default:
                        throw "Invalid message type, or a message type not meant for secondary views was provided";
                }
            },

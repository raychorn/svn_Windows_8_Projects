...
namespace MultipleViews
{
    ...
    public sealed partial class SecondaryViewPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            thisData.Released += viewData_Released;
        }
        ...
        private async void viewData_Released(Object sender, EventArgs e)
        {
            ((ViewData)sender).Released -= viewData_Released;
            // The ViewData object is bound to UI elements on the main thread
            // So, the object must be removed from that thread
            await mainDispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ((App)App.Current).SecondaryViews.Remove(thisData);
            });

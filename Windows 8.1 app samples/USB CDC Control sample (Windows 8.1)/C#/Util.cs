...
namespace UsbCdcControl
{
    ...
    internal sealed class UsbDeviceList : System.Collections.Generic.List<UsbSerialPortInfo>
    {
        ...
        {
            UsbCdcControl.DeviceList.Current.DeviceAdded += this.OnDeviceAdded;
            UsbCdcControl.DeviceList.Current.DeviceRemoved += this.OnDeviceRemoved;
        }

        ~UsbDeviceList()
        {
            UsbCdcControl.DeviceList.Current.StopWatcher();
            UsbCdcControl.DeviceList.Current.DeviceAdded -= this.OnDeviceAdded;
            UsbCdcControl.DeviceList.Current.DeviceRemoved -= this.OnDeviceRemoved;
        }
        ...
        {
            if (!UsbCdcControl.DeviceList.Current.WatcherStarted)
            {
                UsbCdcControl.DeviceList.Current.StartWatcher();
            }
        }

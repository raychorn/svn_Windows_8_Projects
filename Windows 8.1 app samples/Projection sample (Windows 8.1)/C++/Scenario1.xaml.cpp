...
void Scenario1::StartProjecting_Click(Object^ sender, RoutedEventArgs^ e)
{
    ...
    if (MainPage::Current->ProjectionViewPageControl == nullptr)
    {
        ...
        prerequisite = dynamic_cast<App^>(App::Current)->CreateNewView().then([mainViewId, mainDispatcher] (CoreDispatcher^ presentationDispatcher)
        {
            return presentationDispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler([mainViewId, mainDispatcher] ()
            {

...
MainPage::MainPage()
{
    ...
    Window::Current->SizeChanged +=ref new WindowSizeChangedEventHandler(this,&MainPage::MainPage_SizeChanged);
...
void MainPage::MainPage_SizeChanged(Object^ sender, Windows::UI::Core::WindowSizeChangedEventArgs^ args)
{
    CheckResolutionAndViewState();
}

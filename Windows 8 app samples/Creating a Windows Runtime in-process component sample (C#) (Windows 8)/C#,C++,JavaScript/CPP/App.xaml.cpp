...
{
    InitializeComponent();
    this->Suspending += ref new SuspendingEventHandler(this, &ProxyStubsForWinRTComponents::App::OnSuspending);
}
...
void App::SetupWindowing(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs^ pArgs)
{
    if (Window::Current->Content == nullptr)
    {
        ...
        TypeName pageType = { "ProxyStubsForWinRTComponents.MainPage", TypeKind::Custom };

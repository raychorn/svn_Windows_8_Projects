...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class MainPage
        ...
        Private _coreDispatcher As CoreDispatcher
        ...
        Protected Overrides Sub OnNavigatedTo(e As NavigationEventArgs)
            ...
            If launchArgs IsNot Nothing AndAlso launchArgs.Arguments = "Windows.Networking.Proximity.PeerFinder:StreamSocket" Then
     ...
     Dim LocalScenarioList As New System.Collections.ObjectModel.ObservableCollection(Of Object)
        ...
        Public Async Sub NotifyUser(strMessage As String, type As NotifyType)
        ...
        Public Async Sub ClearLog(textBlock As TextBlock)
            Await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, Sub()
        ...
        Public Async Sub UpdateLog(strMessage As String, textBlock As TextBlock)
            Await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, Sub()
                                                                         textBlock.Style = TryCast(Resources("StatusStyle"), Style)
        ...
        Public Function IsLaunchedByTap() As Boolean
            Dim isLaunchedByTapValue As Boolean = _isLaunchedByTap
            _isLaunchedByTap = False
            Return isLaunchedByTapValue
        End Function
    End Class

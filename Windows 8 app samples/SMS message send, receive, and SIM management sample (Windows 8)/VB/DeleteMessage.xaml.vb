...
Partial Public NotInheritable Class DeleteMessage
    ...
    Private Async Sub Delete_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Async Sub DeleteAll_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Async Function DoDeleteAsync(messageId As UInteger) As Task

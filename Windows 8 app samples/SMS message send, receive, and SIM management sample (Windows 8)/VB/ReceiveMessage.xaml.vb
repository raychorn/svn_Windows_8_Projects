...
Partial Public NotInheritable Class ReceiveMessage
    ...
    Private Async Sub Receive_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Async Sub device_SmsMessageReceived(sender As SmsDevice, args As SmsMessageReceivedEventArgs)
        ' Dispatch anonymous function to UI thread to display message properties. 

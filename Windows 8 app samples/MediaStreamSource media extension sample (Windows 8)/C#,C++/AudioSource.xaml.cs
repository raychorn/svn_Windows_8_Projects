...
namespace MediaStreamSource
{
    ...
    /// </summary>
    public sealed partial class AudioSource : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        {
            MediaStreamSource.SetSource(Media, new PcmSource());
        }
        ...
        {
            MediaStreamSource.SetSource(Media, null);
        }
    }
}

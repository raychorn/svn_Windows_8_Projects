...
void OvenClient::OnNavigatedTo(NavigationEventArgs^ e)
{
...
void WRLOutOfProcessWinRTComponent::OvenClient::OvenClientRun(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{

...
{
    InitializeComponent();
    this->Suspending += ref new SuspendingEventHandler(this, &WRLOutOfProcessWinRTComponent::App::OnSuspending);
}
...
void App::SetupWindowing(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs^ pArgs)
{
    if (Window::Current->Content == nullptr)
    {
        ...
        TypeName pageType = { "WRLOutOfProcessWinRTComponent.MainPage", TypeKind::Custom };

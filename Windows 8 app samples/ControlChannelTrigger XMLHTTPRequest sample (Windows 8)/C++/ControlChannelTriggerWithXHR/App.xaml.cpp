...
{
    InitializeComponent();
    this->Suspending += ref new SuspendingEventHandler(this, &ControlChannelTrigger::App::OnSuspending);
}
...
void App::OnLaunched(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs^ pArgs)
{
    ...
    if (Window::Current->Content == nullptr)
    {
        ...
        TypeName pageType = { "ControlChannelTrigger.MainPage", TypeKind::Custom };
        rootFrame->Navigate(pageType);
        Window::Current->Content = rootFrame;
        MainPage^ page=dynamic_cast<MainPage^>(rootFrame->Content);
        page->RootNamespace= "ControlChannelTrigger";
    }

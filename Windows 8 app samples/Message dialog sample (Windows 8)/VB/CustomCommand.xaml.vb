...
Partial Public NotInheritable Class CustomCommand
    ...
    Private Async Sub CustomCommandButton_Click(sender As Object, e As RoutedEventArgs)
        ...
        messageDialog.Commands.Add(New UICommand("Don't install", Sub(command)
                                                                      rootPage.NotifyUser("The 'Don't install' command has been selected.", NotifyType.StatusMessage)
                                                                  End Sub))

        messageDialog.Commands.Add(New UICommand("Install updates", Sub(command)

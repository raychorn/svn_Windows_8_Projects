...
Partial Public NotInheritable Class CancelCommand
    ...
    Private Async Sub CancelCommandButton_Click(sender As Object, e As RoutedEventArgs)
        ' Create the message dialog and set its content
        Dim messageDialog = New MessageDialog("No internet connection has been found.")

        ' Add commands and set their callbacks; both buttons use the same callback function instead of inline event handlers
        messageDialog.Commands.Add(New UICommand("Try again", AddressOf Me.CommandInvokedHandler))
        messageDialog.Commands.Add(New UICommand("Close", AddressOf Me.CommandInvokedHandler))

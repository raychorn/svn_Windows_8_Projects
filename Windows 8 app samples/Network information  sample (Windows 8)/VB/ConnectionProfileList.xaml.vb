...
Partial Public NotInheritable Class ConnectionProfileList
    ...
    ''' <param name="e"></param>
    Private Sub ConnectionProfileList_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Function GetConnectionCostInfo(connectionCost As ConnectionCost) As String
        ...
        If connectionCost Is Nothing Then
            cost &= "Connection cost Noth Available" & vbCrLf
            Return cost
        End If
        ...
        End Select
        cost &= vbLf
        cost &= "Roaming: " & connectionCost.Roaming.ToString & vbLf
        cost &= "Over Data Limit: " & connectionCost.OverDataLimit.ToString & vbLf
        cost &= "Approaching Data Limit : " & connectionCost.ApproachingDataLimit.ToString & vbLf
    ...
    Private Function GetDataPlanStatusInfo(dataPlan As DataPlanStatus) As String
        ...
        If dataPlan Is Nothing Then
            dataplanStatusInfo &= "Dataplan Status not available " & vbCrLf
        ...
        If inboundBandwidth.HasValue Then
            dataplanStatusInfo &= "InboundBitsPerSecond : " & inboundBandwidth.ToString & vbLf
        Else
        ...
        If outboundBandwidth.HasValue Then
            dataplanStatusInfo &= "OutboundBitsPerSecond : " & outboundBandwidth.ToString & vbLf
        Else
        ...
        If dataLimit.HasValue Then
            dataplanStatusInfo &= "DataLimitInMegabytes : " & dataLimit.ToString & vbLf
        Else
        ...
        If maxTransferSize.HasValue Then
            dataplanStatusInfo &= "MaxTransferSizeInMegabytes : " & maxTransferSize.ToString & vbLf
        Else

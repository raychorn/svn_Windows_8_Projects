...
Partial Public NotInheritable Class NetworkStatusChange
    ...
    '
    Private Sub NetworkStatusChange_Click(sender As Object, e As RoutedEventArgs)
        ' register for network status change notifications
        Try
            networkStatusCallback = AddressOf OnNetworkStatusChange
            ...
            Else
                rootPage.NotifyUser(internetProfileInfo.ToString, NotifyType.StatusMessage)
            End If
    ...
    ' 
    Private Async Sub OnNetworkStatusChange(sender As Object)
        ...
        Try
            ...
            If InternetConnectionProfile Is Nothing Then
                Await _cd.RunAsync(CoreDispatcherPriority.Normal, Sub()
    ...
    Private Function GetConnectionProfile(connectionProfile As ConnectionProfile) As String
        ...
        If connectionProfile IsNot Nothing Then
            ...
            connectionProfileInfo &= GetConnectionCostInfo(connectionCost).ToString
            Dim dataPlanStatus As DataPlanStatus = connectionProfile.GetDataPlanStatus()
            connectionProfileInfo &= GetDataPlanStatusInfo(dataPlanStatus).ToString

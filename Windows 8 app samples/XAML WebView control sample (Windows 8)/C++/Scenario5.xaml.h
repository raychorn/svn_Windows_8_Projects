...
namespace SDKSample
{
    namespace WebViewControl
    {
        ...
        private:
    		...
    		void WebView5_LoadCompleted(Platform::Object^ sender, Windows::UI::Xaml::Navigation::NavigationEventArgs^ e);
    		void WebView5_ScriptNotify(Platform::Object^ sender, Windows::UI::Xaml::Controls::NotifyEventArgs^ e);
    	};
    }
}

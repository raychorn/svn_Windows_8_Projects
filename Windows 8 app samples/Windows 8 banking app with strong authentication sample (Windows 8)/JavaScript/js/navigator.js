    ...
    WinJS.Namespace.define("BankApp", {
        PageControlNavigator: WinJS.Class.define(
            ...
            function PageControlNavigator(element, options) {
                ...
                window.attachEvent("resize",this._resized.bind(this));
                ...
                _resized: function (args) {
                    if (this.pageControl && this.pageControl.updateLayout) {
                        this.pageControl.updateLayout.call(this.pageControl, this.pageElement, Windows.UI.ViewManagement.ApplicationView.value);
                    }
                },

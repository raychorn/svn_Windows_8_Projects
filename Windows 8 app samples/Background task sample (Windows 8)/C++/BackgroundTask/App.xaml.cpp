...
App::App()
{
    ...
    SDKSample::BackgroundTask::BackgroundTaskSample::RegisterServicingCompleteBackgroundTask();
    SDKSample::BackgroundTask::BackgroundTaskSample::InitializeBackgroundTaskStatus();
}

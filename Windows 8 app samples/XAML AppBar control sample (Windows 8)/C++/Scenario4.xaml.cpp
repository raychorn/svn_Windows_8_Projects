...
void AppBarControl::Scenario4::ShowMe_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	TypeName pageType = {Page3::typeid->FullName, TypeKind::Custom};

...
Partial Public NotInheritable Class FileSavePicker_FailToSave
    ...
    Private Async Sub OnTargetFileRequested(sender As FileSavePickerUI, e As TargetFileRequestedEventArgs)
        ...
        Await _dispatcher.RunAsync(CoreDispatcherPriority.Normal, Async Sub()

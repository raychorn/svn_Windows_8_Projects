...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class FileOpenPickerPage
        ...
        Private _scenarioList As New List(Of Scenario)() From
        {
            New Scenario With {.Title = "Pick a file from the application package", .ClassType = GetType(Global.FilePickerContracts.FileOpenPicker_PickAppFile)},
            New Scenario With {.Title = "Pick a file from a URI",                   .ClassType = GetType(Global.FilePickerContracts.FileOpenPicker_PickURLFile)},
            New Scenario With {.Title = "Pick cached file",                         .ClassType = GetType(Global.FilePickerContracts.FileOpenPicker_PickCachedFile)}
        }
        ...
        Private Sub FileOpenPickerPage_SizeChanged(sender As Object, e As SizeChangedEventArgs)
            InvalidateSize()

...
Namespace Global.SDKTemplate
    ...
    ''' </summary>
    Partial Public NotInheritable Class CachedFileUpdaterPage
        ...
        Private scenarios As List(Of Scenario) = Nothing
        ...
        Public Sub Activate(args As CachedFileUpdaterActivatedEventArgs)
            ...
            Select Case cachedFileUpdaterUI.UpdateTarget
                Case CachedFileTarget.Local
                    scenarios = New List(Of Scenario) From {New Scenario With {.Title = "Get latest version", .ClassType = GetType(Global.FilePickerContracts.CachedFileUpdater_Local)}}
                    Exit Select
                Case CachedFileTarget.Remote
                    scenarios = New List(Of Scenario) From {New Scenario With {.Title = "Remote file update", .ClassType = GetType(Global.FilePickerContracts.CachedFileUpdater_Remote)}}
                    Exit Select
            End Select
        ...
        Private Async Sub CachedFileUpdaterUI_UIRequested(sender As CachedFileUpdaterUI, args As Object)
        ...
        Private Sub CachedFileUpdaterUI_FileUpdateRequested(sender As CachedFileUpdaterUI, args As FileUpdateRequestedEventArgs)
        ...
        Private Sub CachedFileUpdaterPage_SizeChanged(sender As Object, e As SizeChangedEventArgs)
            InvalidateSize()

...
Partial Public NotInheritable Class Scenario1
    ...
    Private _inclinometer As Inclinometer
    ...
    Public Sub New()
        ...
        If _inclinometer IsNot Nothing Then
            ' Select a report interval that is both suitable for the purposes of the app and supported by the sensor.
            ' This value will be used later to activate the sensor.
            Dim minReportInterval As UInteger = _inclinometer.MinimumReportInterval
    ...
    Protected Overrides Sub OnNavigatingFrom(e As NavigatingCancelEventArgs)
        If ScenarioDisableButton.IsEnabled Then
            ...
            RemoveHandler _inclinometer.ReadingChanged, AddressOf ReadingChanged
    ...
    Private Sub VisibilityChanged(sender As Object, e As VisibilityChangedEventArgs)
        If ScenarioDisableButton.IsEnabled Then
            If e.Visible
                ...
                AddHandler _inclinometer.ReadingChanged, AddressOf ReadingChanged
            Else
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Async Sub ReadingChanged(sender As Object, e As InclinometerReadingChangedEventArgs)
        Await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, Sub()
                                                                     Dim reading As InclinometerReading = e.Reading

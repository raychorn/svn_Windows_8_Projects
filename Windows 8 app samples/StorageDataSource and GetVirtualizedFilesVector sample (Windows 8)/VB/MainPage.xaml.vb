    ...
    Partial Public NotInheritable Class MainPage
        ...
        Private Sub InvalidateSize()
            ...
            If windowWidth <> 0.0 Then
                ...
                If ApplicationView.Value <> ApplicationViewState.Snapped And ApplicationView.Value <> ApplicationViewState.FullScreenPortrait Then
        ...
        Private Sub InvalidateViewState()
            If ApplicationView.Value = ApplicationViewState.Snapped Or ApplicationView.Value = ApplicationViewState.FullScreenPortrait Then

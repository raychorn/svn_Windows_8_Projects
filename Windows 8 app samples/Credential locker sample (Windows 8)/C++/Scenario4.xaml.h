...
namespace SDKSample
{
    namespace PasswordVaultCPP
    {
		...
		void SelectResource_Click(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e);
		void SelectUser_Click(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e);
	};
    }
}

...
#Region "Navigation support"
        ...
        Private Sub CoreDispatcher_AcceleratorKeyActivated(sender As Windows.UI.Core.CoreDispatcher,
            ...
            If (args.EventType = Windows.UI.Core.CoreAcceleratorKeyEventType.SystemKeyDown OrElse
                ...
                Dim downState = Windows.UI.Core.CoreVirtualKeyStates.Down
                Dim menuKey = (coreWindow.GetKeyState(Windows.System.VirtualKey.Menu) And downState) = downState
                Dim controlKey = (coreWindow.GetKeyState(Windows.System.VirtualKey.Control) And downState) = downState
                Dim shiftKey = (coreWindow.GetKeyState(Windows.System.VirtualKey.Shift) And downState) = downState
                Dim noModifiers = Not menuKey AndAlso Not controlKey AndAlso Not shiftKey
                Dim onlyAlt = menuKey AndAlso Not controlKey AndAlso Not shiftKey
...
#Region "Visual state switching"
        ...
        Public Sub InvalidateVisualState()
            If Me._layoutAwareControls IsNot Nothing Then
                Dim visualState = DetermineVisualState(ApplicationView.Value)
...
#Region "Process lifetime management"
        ...
        Protected Overrides Sub OnNavigatedTo(e As Navigation.NavigationEventArgs)
            ...
            If e.NavigationMode = Navigation.NavigationMode.New Then
                ...
                Dim nextPageIndex = Me.Frame.BackStackDepth

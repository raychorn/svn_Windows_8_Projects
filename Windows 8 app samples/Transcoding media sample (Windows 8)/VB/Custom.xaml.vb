...
''' </summary>
Partial Public NotInheritable Class [Custom]
    ...
    Private _Profile As Windows.Media.MediaProperties.MediaEncodingProfile
    ...
    Public Sub New()
        ...
        AddHandler Transcode.Click, AddressOf TranscodeCustom
        ...
        Dim defaultProfile As MediaEncodingProfile = MediaEncodingProfile.CreateMp4(VideoEncodingQuality.Wvga)
...
#Region "Custom specific"
    Private Async Sub TranscodeCustom(sender As Object, e As Windows.UI.Xaml.RoutedEventArgs)
        StopPlayers()
        DisableButtons()
        GetCustomProfile()
        ...
        Try
            If _InputFile IsNot Nothing AndAlso _Profile IsNot Nothing Then
                ...
                Dim preparedTranscodeResult = Await _Transcoder.PrepareFileTranscodeAsync(_InputFile, _OutputFile, _Profile)

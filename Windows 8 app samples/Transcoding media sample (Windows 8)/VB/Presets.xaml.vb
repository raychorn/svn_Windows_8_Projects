...
''' </summary>
Partial Public NotInheritable Class Presets
    ...
    Public Sub New()
        ...
        AddHandler Transcode.Click, AddressOf TranscodePreset
...
#Region "Preset specific"
    Private Async Sub TranscodePreset(sender As Object, e As Windows.UI.Xaml.RoutedEventArgs)
        StopPlayers()
        DisableButtons()

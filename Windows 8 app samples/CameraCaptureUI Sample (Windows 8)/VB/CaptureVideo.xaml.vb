...
Partial Public NotInheritable Class CaptureVideo
    ...
    Private appSettings As IPropertySet
    ...
    Protected Overrides Async Sub OnNavigatedTo(e As NavigationEventArgs)
        ...
        If (appSettings.ContainsKey(videoKey)) Then
            Dim filePath As New Object
            If (appSettings.TryGetValue(videoKey, filePath) And filePath.ToString() <> "") Then
    ...
    ''' <param name="e"></param>
    Private Async Sub CaptureVideo_Click(sender As Object, e As RoutedEventArgs)
        Try
    ...
    ''' <remarks></remarks>
    Private Async Function ReloadVideo(filePath As String) As Task
        Try

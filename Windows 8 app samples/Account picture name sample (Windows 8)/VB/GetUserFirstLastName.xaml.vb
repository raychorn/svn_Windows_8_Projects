...
Partial Public NotInheritable Class GetUserFirstLastName
    ...
    Private Async Sub GetFirstNameButton_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Async Sub GetLastNameButton_Click(sender As Object, e As RoutedEventArgs)

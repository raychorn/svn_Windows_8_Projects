...
Partial Public NotInheritable Class GetAccountPicture
    ...
    Private Async Sub GetSmallImageButton_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Async Sub GetLargeImageButton_Click(sender As Object, e As RoutedEventArgs)
    ...
    Private Async Sub GetVideoButton_Click(sender As Object, e As RoutedEventArgs)

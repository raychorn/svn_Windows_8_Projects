...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class MainPage
        ...
        Private Sub InvalidateViewState()
            ...
            'Since we dont load the sceanrio page in the traditional manner (we just pluck out the 
            'input and output sections from the page) we need to ensure that and VSM code used 
            'by the sceanrios input and output section is fired.
            VisualStateManager.GoToState(CType(InputSection, Control), "Input" & ApplicationView.Value.ToString, False)
            VisualStateManager.GoToState(CType(OutputSection, Control), "Output" & ApplicationView.Value.ToString, False)
        End Sub

...
namespace SDKTemplate
{
    ...
    public sealed partial class MainPage : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private void InvalidateViewState()
        {
            ...
            VisualStateManager.GoToState((Control)InputSection, ApplicationView.Value.ToString(), false);
            VisualStateManager.GoToState((Control)OutputSection, ApplicationView.Value.ToString(), false);
        }
